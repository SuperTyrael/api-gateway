...
import org.brown.mliang21.core.context.IContext;
...
public class ResponseHelper {
	...
	public static void writeResponse(IContext context) {
		...
		if (context.isWritten()) {
			// 1：第一步构建响应对象，并写回数据
			FullHttpResponse httpResponse = ResponseHelper.getHttpResponse(context,
					(GatewayResponse) context.getResponse());
